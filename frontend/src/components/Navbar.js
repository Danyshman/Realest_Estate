...
const Navbar = ({ auth: { isAuthenticated, loading }, logout }) => {
    const authLinks = (
        <a className="navbar__top__auth__link" href="#" onClikc={logout}>
            Logout
        </a>
    );
    const guessLinks = (
        <Fragment>
            <a className="navbar__top__auth__link" href="/login">
                Login
            </a>
            <a className="navbar__top__auth__link" href="/signup">
                Signup
            </a>
        </Fragment>
    );
        ...
        <Fragment>
            <nav className="navbar">
                <div className="navbar__top">
                    <div className="navbar__top__log">
